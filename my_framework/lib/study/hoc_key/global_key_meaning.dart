...
class GlobalKeyMeaning extends StatefulWidget {
  @override
  State<GlobalKeyMeaning> createState() => _GlobalKeyMeaningState();
}

class _GlobalKeyMeaningState extends State<GlobalKeyMeaning> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
          child: Column(
            children: <Widget>[
              Text("Global keys can be used to access the state of a statefull widget from anywhere in the widget tree"),
              Counter(
                key: _counterState,
              ),
            ],
