...
import 'package:my_framework/study/study_ui/ui_lv1.dart';

import 'SizeConfig.dart';
import 'login.dart';


class AuthenApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        child: Text("Back"),
        onPressed: (){
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>UILevel1()), (route)=>false);
        },
      ),
