...
class HireTalentApp extends StatefulWidget {
  @override
  _HireTalentAppState createState() => new _HireTalentAppState();
}

class _HireTalentAppState extends State<HireTalentApp> {
  @override
