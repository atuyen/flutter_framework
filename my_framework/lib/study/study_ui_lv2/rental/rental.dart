...
class RentalServiceApp extends StatefulWidget {
  @override
  _RentalServiceAppState createState() => _RentalServiceAppState();
}

class _RentalServiceAppState extends State<RentalServiceApp> {
  @override
